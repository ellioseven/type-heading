...
Type Heading uses the `MIT`_ license and always will.
...
issue`_ or provide a `pull request`_.

.. _create an issue: https://github.com/ellioseven/type-heading/issues
.. _pull request: https://github.com/ellioseven/type-heading/pulls